using Offers.API.Model;

namespace Microsoft.eShopOnContainers.Services.Offers.API.Controllers
{
    ...
    public class OffersController : ControllerBase
    {
        ...
        public async Task<IActionResult> ItemsAsync([FromQuery] int pageSize = 10, [FromQuery] int pageIndex = 0, string ids = null)
        {
            ...
            */
            ...
            List<OfferItem> itemsOnPage = new List<OfferItem>
            {
                new OfferItem {Id=1, CatalogItemID=4, OfferPrice=10.99M}
            };
            ...
            var model = new PaginatedItemsViewModel<OfferItem>(pageIndex, pageSize, totalItems, itemsOnPage);
